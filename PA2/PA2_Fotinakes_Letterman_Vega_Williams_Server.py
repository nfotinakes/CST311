...
# Date: 2022-05-17
# Assignment Title: PA#2 - UDP Pinger Server
# Description: This program acts as the server to receive pings from the client and randomize
...
while True:
    ...
    print("PING " + str(ping_num) + " Received")
